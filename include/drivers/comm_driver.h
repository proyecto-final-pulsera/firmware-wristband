...
protected:
    ...
    // Cálculo rápido de CRC-8 basado en la tabla
    uint8_t calculateCRC8(const uint8_t* data, uint16_t len, uint8_t initial_crc = 0x00) {
        ...
        uint8_t crc = initial_crc; // Valor inicial
